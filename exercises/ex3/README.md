...
| Address     | jdbc:snowflake://${header.SFAddress}   | Snowflake address    |
...
In the next step we will work with the iFlow to read data from Snowflake database table and then store it in the planning area in SAP IBP. Click here to continue - [Exercise 4 - Reading from Snowflake and writing it to SAP IBP ](../ex3/README.md)
